import {Pane as $hgUW1$Pane} from "tweakpane";
...
class $29ce27527f9f9422$export$b6c32681ca39b455 {
    ...
    enableMouseBlob(enabled) {
        ...
        const f = (evt)=>{
            ...
            this.updateBlob($29ce27527f9f9422$var$mouseBlobId, blobData.x, blobData.y, blobData.width, blobData.height, 0, 0, 0, 0, '');
        };
...
class $708f03dc9214fc57$export$c72f6eaae7b9adff {
    open(settings, onChange, onKill) {
        this.pane = new $hgUW1$Pane();
        ...
        this.pane.addInput(settings, 'handScale', {
            label: 'Hand Scale'
        });
        this.pane.addInput(settings, 'blobScale', {
            label: 'Blob Scale'
        });
        this.pane.addInput(settings, 'simulate', {
            label: 'Simulate single blob with mouse'
        });
...
class $ba7821d2954e0a1e$export$64c1e2689525a052 {
    /**
   * 
   ...
   */ constructor(width, height, simulate, onUpdate, onBlobAdded, onBlobDeleted, onFrameUpdated, onSettingsChanged){
        ...
        this.skeletonBlobs = new $29ce27527f9f9422$export$b6c32681ca39b455($94391c9343d0bcc2$export$189c6ba3eaa96ac2.skel, width, height, 1, onUpdate, onBlobAdded, onBlobDeleted, onFrameUpdated);
        this.singleBlobs = new $29ce27527f9f9422$export$b6c32681ca39b455($94391c9343d0bcc2$export$189c6ba3eaa96ac2.blob, width, height, 1, onUpdate, onBlobAdded, onBlobDeleted, onFrameUpdated);
        this.simulate && this.singleBlobs.enableMouseBlob(true);
        this.settings = new $708f03dc9214fc57$export$c72f6eaae7b9adff();
        window.addEventListener('message', (event)=>{
        ...
        window.addEventListener('keydown', (event)=>{
            if (event.key === this.keyToOpenSettings) this.settingsOpened ? this.closeSettings() : this.openSettings();
        });
    }
    /**
   * Gets skeleton blobs.
...
const $149c1bd638913645$var$broox = {
    ...
    mediaPlayer: {
        BlobsController: $ba7821d2954e0a1e$export$64c1e2689525a052,
